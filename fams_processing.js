function frequencyAnalysis() {
    ...
    function processAnalysis(col){
      ...
      //TODO: REPLACE FAM NAME WITH A FAM NAME
      var analysisName = spreadsheet.getSheetByName("FAM NAME").getRange(col+"9").getValue();
      allSheets.forEach(function(sheet) {
        var dataRanges = [];
        //TODO: Replace with FIRST NAME TO LAST NAME CELL
        var nameRanges = sheet.getRange("B2:B122"); // Assuming names are in the range B2:B122
  
        // Assuming the pattern starts from C10 and increments by 20, Data was stored in rows 10-14, 30-34, etc for us
